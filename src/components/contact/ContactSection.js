            ...
            <div class="flex flex-col gap-10 max-w-2xl mx-auto px-2">
                ...
                <div data-theme="mytheme" class='flex flex-wrap-reverse justify-around'>
                    ...
                    <div class="dropdown dropdown-hover">
                        <a href='mailto:alv.dieg019@gmail.com' target='_blank' rel="noreferrer" class="btn btn-primary mb-1 w-full z-1 relative lg:btn-md">alv.diego19@gmail.com</a>
                        <EmailOptions />
                    </div>
                    <ButtonLight class='w-max btn-md sm:mb-0' goTo='https://www.linkedin.com/in/diego-l%C3%B3pez-821b39196/' target='_blank' rel="noreferrer">Message me on LinkedIn</ButtonLight>
                </div>
